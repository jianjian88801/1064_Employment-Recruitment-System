<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资要求" prop="gongziyaoqiu">
          <el-input v-model="ruleForm.gongziyaoqiu" 
              placeholder="工资要求" clearable  :readonly="ro.gongziyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资要求" prop="gongziyaoqiu">
              <el-input v-model="ruleForm.gongziyaoqiu" 
                placeholder="工资要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiuzhigangwei = true;
          ...
          if(o=='gongziyaoqiu'){
            this.ruleForm.gongziyaoqiu = obj[o];
	    this.ro.gongziyaoqiu = true;
            continue;
          }
          if(o=='jianli'){
